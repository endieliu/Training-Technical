...
class ProjectProject(models.Model):
    ...
    def action_view_planning_shift(self):
        action = self.env['ir.actions.act_window']._for_xml_id('bsp_module.project_planning_slot_action')
    ...
    def action_project_reporting_wizard(self):
        ...
        return {
            ...
            "view_mode" : "form",
            "view_id" : self.env.ref('bsp_module.project_reporting_wizard_view_form').id,
            "target" : "new",
            "context" : context
        }
